...
export class CreateInscriptionDataComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.initSelects();
    this.inscriptionForm?.get('idRunner')?.setValue(sessionStorage.getItem('idRunner'))
  ...
  onSubmit(): void {
    if (this.inscriptionForm.valid) {
      this._inscriptionService.createInscription(this.inscriptionForm.value).subscribe(response =>{
